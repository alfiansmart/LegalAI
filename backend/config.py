...
class Settings(BaseSettings):
    ...
    # default (`anthropic`) preserves prior behaviour; `azure` routes to
    # an Azure OpenAI deployment; `openrouter` lets the firm shop for
    # a model on the open marketplace (anthropic/claude-3.5-sonnet,
    ...
    llm_provider: Literal["anthropic", "azure", "openrouter"] = "anthropic"
